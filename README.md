...
**Digital Health & Telehealth Operations Data Warehouse: Virtual consultation wait times, e-prescription adherence, in-person escalation rates, and video/audio QoS scores.**

[![CI Analytics Pipeline](https://github.com/abdussatarkhan/OmniCare-Telehealth-Patient-Outcomes-Analytics/actions/workflows/ci.yml/badge.svg)](https://github.com/abdussatarkhan/OmniCare-Telehealth-Patient-Outcomes-Analytics/actions)
...
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-brightgreen.svg?style=flat-square)](https://github.com/abdussatarkhan/OmniCare-Telehealth-Patient-Outcomes-Analytics)
...
**OmniCare-Telehealth-Patient-Outcomes-Analytics** is an enterprise-grade analytics data warehouse and business intelligence platform built for **Digital Health & Telehealth Operations**.
...
### 1️⃣ Executive KPI Command Center (Medical Mint & Clinical Teal (Clean Soft))
...
```
                    ...
                    └────────────┬────────────┘
                                 ...
                                 ▼
┌──────────────────────┐   ┌─────────────────────────┐   ┌─────────────────────────┐
│     dim_patients_digital │──►│     fact_teleconsultations │◄──┤     dim_telehealth_clinicians │
└──────────────────────┘   └─────────────┬───────────┘   └─────────────────────────┘
                                         │
       ┌─────────────────────────────────┼─────────────────────────────────┐
       ▼                                 ▼                                 ▼
┌──────────────────────┐   ┌─────────────────────────┐   ┌─────────────────────────┐
│     dim_specialties  │   │     dim_telecom_carriers │   │     dim_date         │
└──────────────────────┘   └─────────────────────────┘   └─────────────────────────┘
```
...
FROM omnicare_dw.fact_teleconsultations f
JOIN omnicare_dw.dim_date dt ON f.date_key = dt.date_key
...
```bash
git clone https://github.com/abdussatarkhan/OmniCare-Telehealth-Patient-Outcomes-Analytics.git
cd OmniCare-Telehealth-Patient-Outcomes-Analytics
