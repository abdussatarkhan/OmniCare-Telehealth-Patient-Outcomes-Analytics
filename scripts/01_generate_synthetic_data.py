"""
OmniCare: Nationwide Digital Primary Care & Telehealth Analytics - Synthetic Telemetry Data Generator
"""
import argparse
import datetime
import os
...
def generate_dataset(n_records=10000, output_dir="data"):
    ...
    print(f"Generating {n_records} records for OmniCare-Telehealth-Patient-Outcomes-Analytics...")
    records = []
